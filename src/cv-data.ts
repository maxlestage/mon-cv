  ...
  skills: [
    {
      ...
      items: ["C", "Go", "Java", "JavaScript", "Kotlin", "LaTeX", "Lua", "PHP", "Ruby", "Rust", "Swift", "TypeScript"],
    },
    {
      category: { fr: "Front-end", en: "Front-end" },
      items: ["Bootstrap", "CSS", "Electron.js", "HTML", "Pinia", "React Native", "React Router", "React Three Fiber", "React.js", "Recoil.js", "Redux", "Tauri", "Three.js", "Vue.js"],
    },
    {
