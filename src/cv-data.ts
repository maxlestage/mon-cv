  ...
  skills: [
    {
      ...
      items: ["Rust", "JavaScript", "TypeScript", "Go", "Java", "C", "Ruby", "PHP", "Kotlin", "Swift", "Lua", "LaTeX"],
    },
    {
      category: { fr: "Front-end", en: "Front-end" },
      items: ["HTML", "CSS", "React.js", "React Native", "Redux", "Recoil.js", "React Router", "Vue.js", "Pinia", "Three.js", "React Three Fiber", "Electron.js", "Tauri", "Bootstrap"],
    },
    {
